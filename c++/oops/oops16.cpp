...
//     i.e., protected.The member which is declared as protected will be accessible to all the member functions within the class as well as the class immediately derived from it.

//           Public : When the member is declared as public,
//     it is accessible to all the functions of the program.
